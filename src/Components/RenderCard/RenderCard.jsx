    ...
    return (
        <div className="container-slider">
            ...
            <div className='container-text'>
                ...
                <button onClick={()=> dispatch({type:"ADD_TO_CART", payload: { idCard, name, imgs, description, price } })} className=" py-1 px-4 rounded-2xl text-black" >Agregar al carrito</button>
            </div>
        </div>
    )
}
